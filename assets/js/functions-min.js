...
$(document).ready(function () {
    $('#biography').addClass('is-active').show();
    $('.nav-link').click(function (event) {
        event.preventDefault();
        var targetId = $(this).attr('href');
        $('.content-section.is-active').fadeOut(500, function () {
            $(this).removeClass('is-active');
            $(targetId).fadeIn(500).addClass('is-active');
        });
    });
});

function f1() {
    document.getElementById("btn_f1").onclick = null;

    $("#1").is(":visible") ? ($("#banner").fadeIn("slow").show(), $("#1").hide()) : $(".options").is(":visible") ? ($(".options").hide(), $("#1").fadeIn("slow").show()) : ($("#banner").hide(), $("#1").fadeIn("slow").show())
    setTimeout(function () {
        document.getElementById("btn_f1").onclick = () => f1();
    }
    ,1000
    )
}
...
function f2() {
    document.getElementById("btn_f2").onclick = null;
    $("#2").is(":visible") ? ($("#banner").fadeIn("slow").show(), $("#2").hide()) : $(".options").is(":visible") ? ($(".options").hide(), $("#2").fadeIn("slow").show()) : ($("#banner").hide(), $("#2").fadeIn("slow").show())

    setTimeout(function () {
        document.getElementById("btn_f2").onclick = () => f2();
    }
        , 1000
    )
}
...
function f3() {
    document.getElementById("btn_f3").onclick = null;
    $("#3").is(":visible") ? ($("#banner").fadeIn("slow").show(), $("#3").hide()) : $(".options").is(":visible") ? ($(".options").hide(), $("#3").fadeIn("slow").show()) : ($("#banner").hide(), $("#3").fadeIn("slow").show())
    setTimeout(function () {
        document.getElementById("btn_f3").onclick = () => f3();
    }
        , 1000
    )
}